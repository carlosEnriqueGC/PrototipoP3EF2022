...
public class frmMantenimientoLinea extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        daoLinea mDAO = new daoLinea();
        List<clsLinea> m = mDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[10];
        for (int i = 0; i < m.size(); i++) {
            dato[0] = Integer.toString(m.get(i).getidl());
            dato[1] = m.get(i).getnombrel();
            dato[2] = m.get(i).getestadol();
    ...
    public void buscarLinea() {
        clsLinea cAConsultar = new clsLinea();
        daoLinea cDAO = new daoLinea();
        cAConsultar.setidl(Integer.parseInt(txtbuscado.getText()));
        cAConsultar = cDAO.query(cAConsultar);
        txtNombre.setText(cAConsultar.getnombrel());
        cbox_estado.setSelectedItem(cAConsultar.getestadol());
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoLinea eDAO = new daoLinea();
        clsLinea eAEliminar = new clsLinea();
        eAEliminar.setidl(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoLinea eDAO = new daoLinea();
        clsLinea eAInsertar = new clsLinea();
        eAInsertar.setnombrel(txtNombre.getText());
        eAInsertar.setestadol(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
        daoLinea eDAO = new daoLinea();
        clsLinea eAActualizar = new clsLinea();
        eAActualizar.setidl(Integer.parseInt(txtbuscado.getText()));
        eAActualizar.setnombrel(txtNombre.getText());
        eAActualizar.setestadol(cbox_estado.getSelectedItem().toString());
