...
import seguridad.modelo.daoMantenimiento4;
 ...
 * @author visitante
 */
public class frmMantenimiento4 extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        daoMantenimiento4 mDAO = new daoMantenimiento4();
        List<clsMantenimiento4> m = mDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[10];
        for (int i = 0; i < m.size(); i++) {
            dato[0] = Integer.toString(m.get(i).getid4());
            dato[1] = m.get(i).getnombre4();
            dato[2] = m.get(i).getestado4();
    ...
    public void buscarCursos() {
        clsMantenimiento4 cAConsultar = new clsMantenimiento4();
        daoMantenimiento4 cDAO = new daoMantenimiento4();
        cAConsultar.setid4(Integer.parseInt(txtbuscado.getText()));
        cAConsultar = cDAO.query(cAConsultar);
        txtNombre.setText(cAConsultar.getnombre4());
        cbox_estado.setSelectedItem(cAConsultar.getestado4());
    }

    public frmMantenimiento4() {
        initComponents();
        llenadoDeTablas();
        estados();
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoMantenimiento4 eDAO = new daoMantenimiento4();
        clsMantenimiento4 eAEliminar = new clsMantenimiento4();
        eAEliminar.setid4(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoMantenimiento4 eDAO = new daoMantenimiento4();
        clsMantenimiento4 eAInsertar = new clsMantenimiento4();
        eAInsertar.setnombre4(txtNombre.getText());
        eAInsertar.setestado4(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
        daoMantenimiento4 eDAO = new daoMantenimiento4();
        clsMantenimiento4 eAActualizar = new clsMantenimiento4();
        eAActualizar.setid4(Integer.parseInt(txtbuscado.getText()));
        eAActualizar.setnombre4(txtNombre.getText());
        eAActualizar.setestado4(cbox_estado.getSelectedItem().toString());
