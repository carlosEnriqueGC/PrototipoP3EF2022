...
import seguridad.modelo.daoMantenimiento5;
 ...
 * @author visitante
 */
public class frmMantenimiento5 extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        daoMantenimiento5 mDAO = new daoMantenimiento5();
        List<clsMantenimiento5> m = mDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[10];
        for (int i = 0; i < m.size(); i++) {
            dato[0] = Integer.toString(m.get(i).getid5());
            dato[1] = m.get(i).getnombre5();
            dato[2] = m.get(i).getestado5();
    ...
    public void buscarCursos() {
        clsMantenimiento5 cAConsultar = new clsMantenimiento5();
        daoMantenimiento5 cDAO = new daoMantenimiento5();
        cAConsultar.setid5(Integer.parseInt(txtbuscado.getText()));
        cAConsultar = cDAO.query(cAConsultar);
        txtNombre.setText(cAConsultar.getnombre5());
        cbox_estado.setSelectedItem(cAConsultar.getestado5());
    }

    public frmMantenimiento5() {
        initComponents();
        llenadoDeTablas();
        estados();
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoMantenimiento5 eDAO = new daoMantenimiento5();
        clsMantenimiento5 eAEliminar = new clsMantenimiento5();
        eAEliminar.setid5(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoMantenimiento5 eDAO = new daoMantenimiento5();
        clsMantenimiento5 eAInsertar = new clsMantenimiento5();
        eAInsertar.setnombre5(txtNombre.getText());
        eAInsertar.setestado5(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
        daoMantenimiento5 eDAO = new daoMantenimiento5();
        clsMantenimiento5 eAActualizar = new clsMantenimiento5();
        eAActualizar.setid5(Integer.parseInt(txtbuscado.getText()));
        eAActualizar.setnombre5(txtNombre.getText());
        eAActualizar.setestado5(cbox_estado.getSelectedItem().toString());
