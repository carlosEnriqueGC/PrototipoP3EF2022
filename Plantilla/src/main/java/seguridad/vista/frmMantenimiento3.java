...
import seguridad.modelo.daoMantenimiento3;
 ...
 * @author visitante
 */
public class frmMantenimiento3 extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        daoMantenimiento3 mDAO = new daoMantenimiento3();
        List<clsMantenimiento3> m = mDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[10];
        for (int i = 0; i < m.size(); i++) {
            dato[0] = Integer.toString(m.get(i).getid3());
            dato[1] = m.get(i).getnombre3();
            dato[2] = m.get(i).getestado3();
    ...
    public void buscarCursos() {
        clsMantenimiento3 cAConsultar = new clsMantenimiento3();
        daoMantenimiento3 cDAO = new daoMantenimiento3();
        cAConsultar.setid3(Integer.parseInt(txtbuscado.getText()));
        cAConsultar = cDAO.query(cAConsultar);
        txtNombre.setText(cAConsultar.getnombre3());
        cbox_estado.setSelectedItem(cAConsultar.getestado3());
    }

    public frmMantenimiento3() {
        initComponents();
        llenadoDeTablas();
        estados();
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        daoMantenimiento3 eDAO = new daoMantenimiento3();
        clsMantenimiento3 eAEliminar = new clsMantenimiento3();
        eAEliminar.setid3(Integer.parseInt(txtbuscado.getText()));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        daoMantenimiento3 eDAO = new daoMantenimiento3();
        clsMantenimiento3 eAInsertar = new clsMantenimiento3();
        eAInsertar.setnombre3(txtNombre.getText());
        eAInsertar.setestado3(cbox_estado.getSelectedItem().toString());
...
//        // TODO add your handling code here:
        daoMantenimiento3 eDAO = new daoMantenimiento3();
        clsMantenimiento3 eAActualizar = new clsMantenimiento3();
        eAActualizar.setid3(Integer.parseInt(txtbuscado.getText()));
        eAActualizar.setnombre3(txtNombre.getText());
        eAActualizar.setestado3(cbox_estado.getSelectedItem().toString());
